...
IMG_SIZE = (128, 128)
OUTPUT_DIR = 'Digital_Maturity_SVM_Results'
os.makedirs(OUTPUT_DIR, exist_ok=True)

print("="*80)
print("SVM - DIGITAL IMAGE MATURITY CLASSIFICATION")
print("="*80)
...
with open(os.path.join(OUTPUT_DIR, 'classification_report.txt'), 'w') as f:
    f.write("SVM DIGITAL MATURITY CLASSIFICATION REPORT\n")
    f.write("="*80 + "\n\n")
...
plt.title('SVM - Digital Maturity Classification\nConfusion Matrix', 
...
ax.set_title('SVM - Digital Maturity: Overfitting Analysis', 
