...
IMG_SIZE = (128, 128)
OUTPUT_DIR = 'Digital_Maturity_KNN_Results'
os.makedirs(OUTPUT_DIR, exist_ok=True)

print("="*80)
print("K-NEAREST NEIGHBORS - DIGITAL IMAGE MATURITY CLASSIFICATION")
print("="*80)
...
with open(os.path.join(OUTPUT_DIR, 'classification_report.txt'), 'w') as f:
    f.write("KNN DIGITAL MATURITY CLASSIFICATION REPORT\n")
    f.write("="*80 + "\n\n")
...
plt.title('KNN - Digital Maturity Classification\nConfusion Matrix', 
...
ax.set_title('KNN - Digital Maturity: Overfitting Analysis', 
