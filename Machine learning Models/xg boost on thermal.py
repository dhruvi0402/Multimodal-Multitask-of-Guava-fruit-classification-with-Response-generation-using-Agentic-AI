...
IMG_SIZE = (128, 128)
OUTPUT_DIR = 'Thermal_Maturity_XGBoost_Results'
os.makedirs(OUTPUT_DIR, exist_ok=True)

print("="*80)
print("XGBOOST - THERMAL IMAGE MATURITY CLASSIFICATION")
print("="*80)
...
with open(os.path.join(OUTPUT_DIR, 'classification_report.txt'), 'w') as f:
    f.write("XGBOOST THERMAL MATURITY CLASSIFICATION REPORT\n")
    f.write("="*80 + "\n\n")
...
plt.title('XGBoost - Thermal Maturity Classification\nConfusion Matrix', 
...
plt.title('XGBoost - Thermal Maturity: Training and Validation Loss', 
...
plt.title(f'XGBoost - Thermal Maturity: Top {top_n} Feature Importances', 
          fontsize=14, fontweight='bold')
...
ax.set_title('XGBoost - Thermal Maturity: Overfitting Analysis', 
