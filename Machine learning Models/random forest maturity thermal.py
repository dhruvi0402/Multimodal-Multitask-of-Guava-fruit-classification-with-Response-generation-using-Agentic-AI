...
IMG_SIZE = (128, 128)
OUTPUT_DIR = 'Thermal_Maturity_RandomForest_Results'
os.makedirs(OUTPUT_DIR, exist_ok=True)

print("="*80)
print("RANDOM FOREST - THERMAL IMAGE MATURITY CLASSIFICATION")
print("="*80)
...
with open(os.path.join(OUTPUT_DIR, 'classification_report.txt'), 'w') as f:
    f.write("RANDOM FOREST THERMAL MATURITY CLASSIFICATION REPORT\n")
    f.write("="*80 + "\n\n")
...
plt.title('Random Forest - Thermal Maturity Classification\nConfusion Matrix', 
...
ax.set_title('Random Forest - Thermal Maturity: Overfitting Analysis', 
...
plt.title(f'Random Forest - Thermal Maturity: Top {top_n} Feature Importances', 
